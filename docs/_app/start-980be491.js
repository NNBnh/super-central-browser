...
var ze = (s, e, t) =>
		e in s ? it(s, e, { enumerable: !0, configurable: !0, writable: !0, value: t }) : (s[e] = t),
	A = (s, e) => {
		for (var t in e || (e = {})) Je.call(e, t) && ze(s, t, e[t]);
		if (fe) for (var t of fe(e)) Ke.call(e, t) && ze(s, t, e[t]);
		return s;
	},
	se = (s, e) => at(s, ot(e));
var Be = (s, e) => {
	...
	if (s != null && fe) for (var r of fe(s)) e.indexOf(r) < 0 && Ke.call(s, r) && (t[r] = s[r]);
	return t;
};
import {
	n as be,
...
function ue(s, e = be) {
	...
	function l(n) {
		if (nt(s, n) && ((s = n), t)) {
			const i = !H.length;
			for (const a of r) a[1](), H.push(a, s);
			if (i) {
...
function vt(s) {
	...
	function f(n) {
		let i = {};
		for (let a = 0; a < l.length; a += 1) i = ce(i, l[a]);
		return { props: i };
	}
	return (
		o && (e = new o(f())),
		{
			...
			l(n) {
				e && ie(e.$$.fragment, n), (t = P());
			},
			m(n, i) {
				e && q(e, n, i), D(n, t, i), (r = !0);
			},
			p(n, i) {
				const a = i & 2 ? ae(l, [oe(n[1] || {})]) : {};
				if (o !== (o = n[0][0])) {
					if (e) {
						Y();
						const d = e;
					...
					o
						? ((e = new o(f())), V(e.$$.fragment), C(e.$$.fragment, 1), q(e, t.parentNode, t))
						: (e = null);
				} else o && e.$set(a);
			},
			i(n) {
				r || (e && C(e.$$.fragment, n), (r = !0));
			},
			o(n) {
				e && x(e.$$.fragment, n), (r = !1);
			},
			d(n) {
				n && I(t), e && z(e, n);
			}
		...
		o && (e = new o(f(s))),
		{
			...
			p(n, i) {
				...
				if ((i & 525 && (a.$$scope = { dirty: i, ctx: n }), o !== (o = n[0][0]))) {
					...
					o
						? ((e = new o(f(n))), V(e.$$.fragment), C(e.$$.fragment, 1), q(e, t.parentNode, t))
						: (e = null);
				} else o && e.$set(a);
			},
			i(n) {
...
function Et(s) {
	...
	var o = s[0][1];
	function f(n) {
		let i = { $$slots: { default: [St] }, $$scope: { ctx: n } };
		for (let a = 0; a < l.length; a += 1) i = ce(i, l[a]);
		return { props: i };
	}
	return (
...
function Me(s) {
	...
	return {
		c() {
			(e = ft('div')), t && t.c(), this.h();
		},
		l(r) {
			e = ut(r, 'DIV', { id: !0, 'aria-live': !0, 'aria-atomic': !0, style: !0 });
			var l = dt(e);
			t && t.l(l), l.forEach(I), this.h();
		},
		h() {
			ye(e, 'id', 'svelte-announcer'),
				ye(e, 'aria-live', 'assertive'),
				ye(e, 'aria-atomic', 'true'),
		...
		m(r, l) {
			D(r, e, l), t && t.m(e, null);
		},
		p(r, l) {
			r[5] ? (t ? t.p(r, l) : ((t = Fe(r)), t.c(), t.m(e, null))) : t && (t.d(1), (t = null));
		},
		d(r) {
			r && I(e), t && t.d();
		}
...
function Lt(s) {
	...
	return {
		...
		l(d) {
			t.l(d), (r = gt(d)), a && a.l(d), (l = P());
		},
		m(d, S) {
			n[e].m(d, S), D(d, r, S), a && a.m(d, S), D(d, l, S), (o = !0);
		},
		p(d, [S]) {
			let v = e;
			(e = i(d)),
				e === v
					...
					: (Y(),
					  ...
					  M(),
					  (t = n[e]),
					  t ? t.p(d, S) : ((t = n[e] = f[e](d)), t.c()),
					  C(t, 1),
					  t.m(r.parentNode, r)),
				d[4]
					? a
						? a.p(d, S)
						: ((a = Me(d)), a.c(), a.m(l.parentNode, l))
					: a && (a.d(1), (a = null));
		},
		i(d) {
			o || (C(t), (o = !0));
...
function Ut(s, e, t) {
	let { stores: r } = e,
		...
		{ props_1: n = null } = e,
		{ props_2: i = null } = e;
	wt('__svelte__', r), bt(r.page.notify);
	let a = !1,
		d = !1,
		S = null;
	return (
		Ee(() => {
			const v = r.page.subscribe(() => {
				a && (t(5, (d = !0)), t(6, (S = document.title || 'untitled page')));
			});
			return t(4, (a = !0)), v;
		}),
		(s.$$set = (v) => {
			'stores' in v && t(7, (r = v.stores)),
...
const Ot = 'modulepreload',
	Ge = {},
	At = '/super-central-browser/_app/',
	ve = function (e, t) {
		return !t || t.length === 0
			? e()
			: Promise.all(
					t.map((r) => {
						if (((r = `${At}${r}`), r in Ge)) return;
						Ge[r] = !0;
						...
						if (
							...
							return new Promise((n, i) => {
								f.addEventListener('load', n),
									f.addEventListener('error', () => i(new Error(`Unable to preload CSS for ${r}`)));
							});
					})
			  ).then(() => e());
	},
	...
	Re = [
		() =>
			ve(
				() => import('./pages/__layout.svelte-270912d0.js'),
				[
					'pages/__layout.svelte-270912d0.js',
					'assets/pages/__layout.svelte-c9bef58c.css',
					'chunks/index-974193a7.js'
				]
			),
		() =>
			ve(
				() => import('./error.svelte-f9428f06.js'),
				['error.svelte-f9428f06.js', 'chunks/index-974193a7.js']
			),
		() =>
			ve(
				() => import('./pages/index.svelte-f54d0e8a.js'),
				[
					'pages/index.svelte-f54d0e8a.js',
					'assets/pages/index.svelte-9f7439be.css',
					'chunks/index-974193a7.js'
				]
			)
	],
...
function He(s) {
	...
	if (s.error || e) {
		...
		const r = typeof s.error == 'string' ? new Error(s.error) : s.error;
...
function tt(s) {
	...
	return { notify: r, set: l, subscribe: o };
}
function It() {
	...
	async function l() {
		clearTimeout(r);
		const f = await fetch(`${st}/_app/version.json`, {
			headers: { pragma: 'no-cache', 'cache-control': 'no-cache' }
		});
		if (f.ok) {
			const { version: n } = await f.json(),
				i = n !== t;
			return i && (s(!0), clearTimeout(r)), i;
		} else throw new Error(`Version check failed: ${f.status}`);
	}
	return { subscribe: e, check: l };
}
function Tt(s, e) {
	let r = `script[sveltekit\\:data-type="data"][sveltekit\\:data-url=${JSON.stringify(
		typeof s == 'string' ? s : s.url
	)}]`;
	e && typeof e.body == 'string' && (r += `[sveltekit\\:data-body="${jt(e.body)}"]`);
							...
							.map((o, f, n) => {
								...
								return (
									...
									o
										...
										.map((d, S) => {
											if (S % 2) {
												const [, v, Q, F] = Dt.exec(d);
												return e.push(Q), t.push(F), v ? '(.*?)' : '([^/]+?)';
											}
											return (
												a && d.includes('.') && (r = !1),
												d
...
function zt(s, e, t) {
	return Object.entries(e).map(([l, [o, f, n]]) => {
		const { pattern: i, names: a, types: d } = Vt(l);
		return {
			id: l,
			exec: (S) => {
				const v = i.exec(S);
				if (v) return qt(v, a, d, t);
			},
			a: o.map((S) => s[S]),
			b: f.map((S) => s[S]),
			has_shadow: !!n
...
let re = {};
try {
	re = JSON.parse(sessionStorage[rt]);
} catch {}
function ke(s) {
	re[s] = Se();
}
function Bt({ target: s, session: e, base: t, trailing_slash: r }) {
	var Te, De;
	const l = new Map(),
		o = new Set(),
		f = { url: tt({}), page: tt({}), navigating: ue(null), session: ue(e), updated: It() },
	...
	f.session.subscribe(async (c) => {
		(Ue = c), Ne && ((Q += 1), me(new URL(location.href), [], !0));
	}),
		(Ne = !0);
	let de = 0,
		G = !0,
		T = (De = (Te = history.state) == null ? void 0 : Te[B]) != null ? De : 0;
	T === 0 && history.replaceState(se(A({}, history.state), { [B]: 0 }), '', location.href);
	const pe = re[T];
	...
	async function me(c, _, b, u) {
		...
		if (((v = !0), u && u.details)) {
			...
			(y.state[B] = T += L), history[y.replaceState ? 'replaceState' : 'pushState'](y.state, '', c);
		}
		if ((d ? ((a = m.state), Le.$set(m.props)) : Ce(m), u)) {
			const { scroll: y, keepfocus: L } = u;
			if (!L) {
				const p = document.body,
					E = p.getAttribute('tabindex');
				(R = getSelection()) == null || R.removeAllRanges(),
					(p.tabIndex = -1),
					p.focus(),
		...
		(n.promise = null), (n.id = null), (S = !0), (v = !1), m.props.page && (he = m.props.page);
	...
	function Ce(c) {
		...
		if (
			(_ && _.remove(),
			(he = c.props.page),
			(Le = new Nt({ target: s, props: se(A({}, c.props), { stores: f }), hydrate: !0 })),
			(d = !0),
			G)
		) {
	...
	async function ge({ url: c, params: _, stuff: b, branch: u, status: h, error: w, routeId: m }) {
		var L;
		const $ = u.filter(Boolean),
			...
			k = {
				...
				state: { url: c, params: _, branch: u, session_id: Q },
	...
	async function Z({
		...
		if (b.load) {
			const y = {
				...
				get session() {
					return (g.uses.session = !0), R;
				},
				get stuff() {
					return (g.uses.stuff = !0), A({}, w);
				},
				fetch(p, E) {
					const J = typeof p == 'string' ? p : p.url,
						{ href: X } = new URL(J, u);
					return g.uses.dependencies.add(X), d ? fetch(p, E) : Tt(p, E);
				}
			};
			_ && ((y.status = c), (y.error = _));
			const L = await b.load.call(null, y);
			if (!L) throw new Error('load function must return a value');
			(g.loaded = He(L)), g.loaded.stuff && (g.stuff = g.loaded.stuff);
		} else m && (g.loaded = He({ props: m }));
		return g;
	}
		...
		e: for (let U = 0; U < w.length; U += 1) {
			...
			try {
				...
				if (
					...
					if (
						(p ||
							(N = await Z({ module: O, url: _, params: b, props: W, stuff: R, routeId: u.id })),
						N && (Ve && (N.uses.url = !0), N.loaded))
					) {
						if (N.loaded.fallthrough)
							throw new Error(
								'fallthrough is no longer supported. Use matchers instead: https://kit.svelte.dev/docs/routing#advanced-routing-matching'
							);
						if (
							(N.loaded.error && ((L = N.loaded.status), (p = N.loaded.error)), N.loaded.redirect)
						)
							return { redirect: N.loaded.redirect, props: {}, state: a };
						N.loaded.stuff && (y = !0);
					}
				} else N = j;
			} catch (O) {
			...
			if (p) {
					...
					if (m[U]) {
						...
						try {
							...
							(J = O == null ? void 0 : O.loaded) != null &&
								J.stuff &&
								(R = A(A({}, R), O.loaded.stuff)),
								(k = k.slice(0, le + 1).concat(O));
							break e;
						} catch {
							continue;
						}
				...
				(X = N == null ? void 0 : N.loaded) != null && X.stuff && (R = A(A({}, R), N.loaded.stuff)),
					k.push(N);
		}
		return await ge({ url: _, params: b, stuff: R, branch: k, status: L, error: p, routeId: u.id });
	}
	async function ee({ status: c, error: _, url: b, routeId: u }) {
		var $, g;
		const h = {},
			w = await Z({ module: await Jt, url: b, params: h, stuff: {}, routeId: u }),
			m = await Z({
				status: c,
				error: _,
				module: await Kt,
		...
		return await ge({
			...
			params: h,
			stuff: A(
				A({}, ($ = w == null ? void 0 : w.loaded) == null ? void 0 : $.stuff),
	...
	async function we({
		...
		const R = Ct(c.pathname, r),
			y = new URL(c.origin + R + c.search + c.hash);
		ke(T), w(), de++;
		const L = (Ae = {});
		if (
			(d && f.navigating.set({ from: a.url, to: y }),
			await me(y, u, !1, { scroll: _, keepfocus: b, details: h }),
			de--,
			Ae === L && !de)
		) {
			const p = { from: $, to: y };
			...
			(history.scrollRestoration = 'manual'),
				...
				addEventListener('visibilitychange', () => {
					if (document.visibilityState === 'hidden') {
						ke(T);
						try {
							sessionStorage[rt] = JSON.stringify(re);
						} catch {}
					}
				});
			const c = (u) => {
				const h = Ze(u);
				h && h.href && h.hasAttribute('sveltekit:prefetch') && xe(et(h));
			};
			let _;
			const b = (u) => {
				clearTimeout(_),
			...
			addEventListener('touchstart', c),
				...
				addEventListener('click', (u) => {
					...
					if (k !== void 0 && g === location.href.split('#')[0]) {
						(_e = !0), ke(T), f.page.set(se(A({}, he), { url: m })), f.page.notify();
						return;
					}
					we({
						url: m,
				...
				addEventListener('hashchange', () => {
					_e &&
						((_e = !1),
						history.replaceState(se(A({}, history.state), { [B]: ++T }), '', location.href));
				});
		},
			...
			try {
				for (let R = 0; R < b.length; R += 1) {
					...
					if ((L && (p.uses.dependencies.add(w.href), (p.uses.url = !0)), m.push(p), p && p.loaded))
						...
						} else p.loaded.stuff && ($ = A(A({}, $), p.loaded.stuff));
				}
				g = k
					? await ee(k)
					: await ge({ url: w, params: u, stuff: $, branch: m, status: c, error: _, routeId: h });
			} catch (R) {
				if (_) throw R;
				g = await ee({ status: 500, error: Xe(R), url: w, routeId: h });
			}
			g.redirect && (await te(new URL(g.redirect, location.href))), Ce(g);
		}
	};
}
async function Mt({
	...
	const n = Bt({ target: e, session: t, base: s.base, trailing_slash: o });
	yt(s),
		f && (await n._hydrate(f)),
		r && (l && n.goto(location.href, { replaceState: !0 }), n._start_router()),
